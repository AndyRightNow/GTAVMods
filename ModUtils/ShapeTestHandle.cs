...
namespace ADModUtils
{
	...
	/// </summary>
	public class ShapeTestHandle: INativeValue, IEquatable<ShapeTestHandle>
	{
		internal ShapeTestHandle(int handle)
		{
			Handle = handle;
		}
		...
		{
			NativeHelper.NativeVector3 hitPositionArg;
			bool hitSomethingArg;
			int guidHandleArg;
            NativeHelper.NativeVector3 surfaceNormalArg;
		...
		{
			return (InputArgument)(ulong)value.Handle;
		}
