...
namespace ADModUtils
{
	public static class ShapeTest
	{
		...
		{
			NativeHelper.NativeVector3 outProbeStartPositionNative;
            NativeHelper.NativeVector3 outProbeEndPositionNative;
			ShapeTestHandle handle;

			unsafe
			{
				handle = new ShapeTestHandle(Function.Call<int>(Hash._START_SHAPE_TEST_SURROUNDING_COORDS,
